class Product {
  ...
  static List<Product> getProducts() {
    ...
    items.add(Product(
        ...
        isFavorite: false,
        details:
            "Sed congue enim aliquet nisi ullamcorper bibendum. Mauris velit sapien, aliquet facilisis lobortis sit amet, pharetra et neque. Quisque fringilla nisi eget orci imperdiet, sed scelerisque risus pulvinar",
        imageUrl:
